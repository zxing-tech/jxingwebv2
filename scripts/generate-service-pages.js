...
const pages = [
  ...
  },
  {
    ...
    title: 'AI, Predictive Analytics and Workflow Automation Malaysia',
    eyebrow: 'Intelligence',
    heading: 'Turn governed business data into useful predictions and controlled automation.',
    description: 'JXING designs AI-assisted workflows and predictive analytics systems for forecasting, lead quality, customer behaviour, document processing, approvals, and operational decisions.',
    intro: 'AI is useful when it is connected to a defined workflow, reliable data, a measurable decision, and human accountability. JXING begins with data readiness and process mapping before selecting models or automation tools.',
    deliverables: ['Data readiness and use-case assessment', 'Workflow, decision and exception mapping', 'Predictive analytics or automation architecture', 'Controlled pilot with human checkpoints', 'Evaluation, monitoring and fallback design', 'Handover and improvement roadmap'],
    useCases: ['Demand and revenue forecasting', 'Lead quality and propensity signals', 'Customer churn and next-best-action support', 'Document intake and classification', 'CRM, accounting and workspace automation', 'Internal knowledge and decision assistants'],
    faqs: [
      ['What predictive analytics can JXING build?', 'Suitable use cases may include demand forecasts, lead scoring, churn signals, anomaly detection, and next-best-action support. Feasibility depends on data quality, volume, history, and the decision being improved.'],
      ...
      ['How does JXING reduce AI risk?', 'We define allowed data, decision boundaries, human approvals, evaluation criteria, monitoring, audit logs, and fallback behaviour before production use.']
    ]
  },
  {
    slug: 'performance-marketing',
    title: 'Performance Marketing and Growth Analytics Malaysia',
    eyebrow: 'Acquire',
    heading: 'Connect paid acquisition to the web product and the outcomes that matter.',
    description: 'JXING plans and operates performance marketing across paid search and paid social, supported by conversion-ready landing experiences, attribution, analytics, and structured experimentation.',
    intro: 'Performance marketing works best when campaigns, landing pages, conversion events, lead quality, and downstream business outcomes are measured as one customer journey. JXING connects acquisition activity to the web systems and analytics foundation we build.',
    deliverables: ['Acquisition and measurement audit', 'Channel, audience and offer strategy', 'Landing-page and conversion journey review', 'Campaign setup and tracking validation', 'Experiment and optimisation roadmap', 'Performance reporting tied to agreed outcomes'],
    useCases: ['Paid search and paid social campaigns', 'Product or service launch acquisition', 'Lead-generation and qualification funnels', 'E-commerce revenue campaigns', 'Landing-page experimentation', 'Attribution and conversion measurement'],
    faqs: [
      ['Does JXING guarantee ROAS or lead volume?', 'No. Results depend on the offer, market, budget, creative, sales process, measurement quality, and competition. JXING agrees the test plan and success criteria before scaling.'],
      ['Why connect performance marketing to web development?', 'Campaign performance depends on page speed, message continuity, conversion UX, analytics, and reliable event tracking. Building these together reduces gaps between media activity and the customer experience.'],
      ['Can JXING manage only the campaigns?', 'A campaign-only scope may be considered after measurement, landing-page, access, and responsibility boundaries are reviewed.']
    ]
  }
];
